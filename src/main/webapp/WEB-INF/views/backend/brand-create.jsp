				...
				<div class="page-wrapper">
					...
					<div class="row">
						<div class="col-lg-8 offset-lg-2">
							<h4 class="page-title">Thêm nhãn hiệu</h4>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-8 offset-lg-2">
							<form>
								<div class="form-group">
									...
									<input class="form-control" id="brand-name" value="" type="text">
								</div>
								<div class="form-group">
			...
			$(document).ready(function(){
			  $(".saveCate").click(function(e){
				e.preventDefault();
				    $.ajax({
					     type: "PUT",
					     url: "${pageContext.request.contextPath}/admin/api/brand?name="+$('#brand-name').val(),
					     dataType: "script",
